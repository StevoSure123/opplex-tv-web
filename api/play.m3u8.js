export default async function handler(req, res) {
  try {
    ...
    const proxiedUrl = `https://m3u8-proxy-six.vercel.app/m3u8-proxy?url=https://test.streamhub.uno/opplex.php?id=${id}&headers=%7B%22referer%22%3A%22https%3A%2F%2F9anime.pl%22%7D`;
